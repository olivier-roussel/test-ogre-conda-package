...
*/
vpAROgre::vpAROgre(unsigned int width, unsigned int height, const char *resourcePath,
  ...
  mPixelBuffer(), mBackground(nullptr), mBackgroundHeight(0), mBackgroundWidth(0),
  mWindowHeight(height), mWindowWidth(width), windowHidden(false), mNearClipping(0.001), mFarClipping(200), 
...
void vpAROgre::init(bool
                    ...
                    bool hidden)
{
  mBackgroundWidth = 1024;
  mBackgroundHeight = 768;
...
*/
Ogre::Vector3 vpAROgre::getPosition(const std::string &sceneName) const
{
  return mSceneMgr->getSceneNode(sceneName)->getPosition();
}
...
/*!
  ...
  background.
*/
void vpAROgre::createBackground()
{
...
*/
void vpAROgre::updateBackgroundTexture()
{
...
*/
void vpAROgre::updateCameraParameters()
{
...
*/
void vpAROgre::getRenderingOutput()
{
  updateCameraParameters();
