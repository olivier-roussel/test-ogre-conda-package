...
{
public:
  vpAROgre(unsigned int width = 0, unsigned int height = 0,
  ...
  */
  ...
  void addRotation(const std::string &sceneName);
  ...
  */
  ...
  Ogre::Vector3 getPosition(const std::string &sceneName) const;

  void getRenderingOutput();
  ...
  */
  ...
  void setPosition(const std::string &sceneName);
  ...
  */
  ...
  void setRotation(const std::string &sceneName);
...
protected:
  virtual void _init(bool bufferedKeys = false, bool hidden = false);
